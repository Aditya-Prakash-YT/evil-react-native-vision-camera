...
cp -v "$SCRIPT_DIR/android/build.gradle" "$TARGET_DIR/android/build.gradle"
cp -v "$SCRIPT_DIR/android/gradle/wrapper/gradle-wrapper.properties" "$TARGET_DIR/android/gradle/wrapper/gradle-wrapper.properties"
